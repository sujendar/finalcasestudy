...
public class ReaderController {
	...
	@GetMapping(value="/books/cancelsub/{userId}/{bookId}")
	public ResponseEntity<ResponseParms> cancelSubscribe(@PathVariable String userId,@PathVariable String bookId) {
		ResponseParms responseParams=booksSubscribe.cancelSubscription(Long.valueOf(userId),Long.valueOf(bookId));
		return new ResponseEntity<ResponseParms>(responseParams,HttpStatus.OK);
}
	@GetMapping(value="/books/viewcontent/{bookId}")
	public ResponseEntity<ResponseParms> viewContent(@PathVariable String bookId) {
		ResponseParms responseParams=booksService.viewBookContent(Long.valueOf(bookId));
		return new ResponseEntity<ResponseParms>(responseParams,HttpStatus.OK);
}
}
